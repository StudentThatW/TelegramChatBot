...
class BullsAndCowsAnswers {
    static String numberLengthRequestLine = "Go play bulls and cows.\n" +
            "How long do I guess the number? Enter a number from 2 to 9";
    static String inncorrectLengthLine = "It is incorrect length for number. Please enter a number from 2 to 9";
    static String NumberGenerationLine = "I made a number. Try to guess it\n" + 1 + " Attempt. Enter your number";
    ...
    static String notDigitsLine = "There are not only digits in your input. Input must contain only digits";
    static String repeatedDigitsLine = "You entered a number with repeated digits. Enter a number without duplicate digits.";
}
